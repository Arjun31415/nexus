...
in {
  ...
  rustrover = buildRustRover rec {
    pname = "rustrover";
    version = products.rustrover.version;
    buildNumber = products.rustrover.build_number;
    description = "Professional IDE for Web and PHP developers";
    license = lib.licenses.unfree;
    src = fetchurl {
      url = products.rustrover.url;
      sha256 = products.rustrover.sha256;
    };
    wmClass = "jetbrains-phpstorm";
    update-channel = products.rustrover.update-channel;
  };
