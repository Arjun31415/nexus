{
  ...
  davinci = (
    stdenv.mkDerivation rec {
      ...
      version = "19 Public Beta 6";
      versionSymbolic = "19.0b6";
      ...
      src =
        ...
        rec {
          ...
          outputHash =
            ...
            else "sha256-v1lTavn960uxkYVK1JlcyZrWRRATzrUZv1+A5+rwqAo=";
      ...
      installPhase = let
        appimageName = "DaVinci_Resolve_${lib.optionalString studioVariant "Studio_"}${versionSymbolic}_Linux.run";
      in ''
        runHook preInstall
